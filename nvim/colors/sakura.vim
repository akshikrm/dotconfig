" Base16 Sakura (https://github.com/chriskempson/base16)
" Scheme: Akshay Krishna (https://github.com/akshikrm)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-sakura.".&background.".sh"
  endif
endif
